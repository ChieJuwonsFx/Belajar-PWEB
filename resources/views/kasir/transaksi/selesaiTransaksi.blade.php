<x-kasir>
    <div class="px-6 pt-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 mb-6">
            <form method="GET" action="{{ route('kasir.transaksi.selesai') }}" id="filter-form">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-lg font-medium text-gray-900">Tidak ada transaksi yang selesai</h3>
