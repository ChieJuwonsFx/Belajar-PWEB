        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <button onclick="window.history.back()"
                    class="px-4 py-2 bg-primary  border border-primary rounded-md text-white hover:bg-white hover:text-primary transition">
                    Kembali
                </button>
                    ...
                    <div class="mt-2 space-y-1">
                        ...
                        @elseif($transaction->transaction_type === 'Offline')
                            <p class="text-sm text-gray-600">
                                ...
                                {{ $transaction->customer_offline ?? 'Pelanggan Umum' }}
                            </p>
                        @endif
                    </div>
                </div>
                                        ...
                                        <div class="flex items-center">
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">
                                                    {{ $item->stock->variant ?? 'Standard' }}</div>
                                            </div>
                                        </div>
                                    </td>
