<x-user>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
                <div class="flex w-full lg:w-1/2 justify-center">
                    <img src="https://img.pikbest.com/png-images/20240713/funny-cute-panda-clipart_10665937.png!w700wp"
                        alt="illustration" class="w-auto h-80 rounded-lg " />
                </div>
                <div class="w-full text-center lg:text-left">
                    ...
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center lg:justify-start sm:space-y-0">
                        ...
                        {{-- <a href="#" class="py-3 px-5 sm:ms-4 text-sm font-medium text-primary bg-white rounded-lg border border-primary hover:bg-primary hover:text-white focus:outline-none focus:ring-4 focus:ring-gray-100">
                  Register
                </a> --}}
                    </div>
                </div>
    ...
    <div class="py-5 px-8 my-4 mx-auto max-w-screen-xl">
        <div class="mb-8">
            <h1
                ...
                Get back to growth with <span class="text-terti">the world's #1</span> CRM.</h1>
            <p class="text-lg mx-6 text-center font-normal text-secondary lg:text-xl">Here at Flowbite
                we focus on markets where technology, innovation, a Here at Flowbite we focus on markets where
        ...
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2">
            <article class="p-6 bg-white rounded-lg border border-primary shadow-md">
                <div class="flex justify-between items-center mb-5 text-primary">
                    <a href=""
                        class="bg-primary-100 hover:underline text-primary text-l font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                    ...
                    <span class="text-sm">20 menit yang lalu</span>
                </div>
                <img src="https://plus.unsplash.com/premium_photo-1664474619075-644dd191935f?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aW1hZ2V8ZW58MHx8MHx8fDA%3D"
                    alt="" class="rounded-lg mb-4 border-solid border border-primary" />
                <h2
                    class="mb-2 text-2xl font-bold tracking-tight text-primary hover:text-terti  line-clamp-2 min-h-[2.5rem]">
                    <a href="">Hahahahha hahahahha ahahhaha</a></h2>
                <p class="mb-5 font-normal text-secondary line-clamp-2">Hahahahha hahahahha ahahhaha Hahahahha hahahahha
                    ahahhaha Hahahahha hahahahha ahahhaha Hahahahha hahahahha ahahhaha Hahahahha hahahahha ahahhaha</p>
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        <img class="w-7 h-7 rounded-full"
                            src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" />
                        <a href="" class="font-medium text-primary hover:text-secondary">Nama Sosososo
                        </a>
                    </div>
                    <a href="" class="inline-flex items-center font-medium text-primary hover:underline">Read
                        More
            ...
            <article class="p-6 bg-white rounded-lg border border-primary shadow-md">
                ...
                <h2
                    class="mb-2 text-2xl font-bold tracking-tight text-primary hover:text-terti  line-clamp-2 min-h-[2.5rem]">
                    <a href="">Hahahahha hahahahha ahahhaha</a></h2>
                <p class="mb-5 font-normal text-secondary line-clamp-2">Hahahahha hahahahha ahahhaha Hahahahha
                    hahahahha ahahhaha Hahahahha hahahahha ahahhaha Hahahahha hahahahha ahahhaha Hahahahha hahahahha
                    ahahhaha</p>
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        <img class="w-7 h-7 rounded-full"
    ...
    <section class="bg-primary">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-10">
                ...
                <p class="text-white sm:text-xl">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 md:space-y-0">
                <div>
                    <div class="flex justify-center items-center w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12">
                    ...
                    <p class="text-white">Plan it, create it, launch it. Collaborate seamlessly with all  the organization and hit your marketing goals every month with our marketing plan.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12">
                    ...
                    <p class="text-white">Protect your organization, devices and stay compliant with our structured workflows and custom permissions made for you.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12">
                    ...
                    <p class="text-white">Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12">
                    ...
                    <p class="text-white">Audit-proof software built for critical financial operations like month-end close and quarterly budgeting.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12">
                    ...
                    <p class="text-white">Craft beautiful, delightful experiences for both marketing and product with real cross-company collaboration.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12">
                    ...
                    <p class="text-white">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
                </div>
            </div>
        </div>
      </section>
    ...
    <div class="py-4 px-8 mt-24 mx-auto max-w-screen-xl">
        <div class="text-center">
            <h1 class="mb-4 text-4xl font-bold leading-none tracking-tight text-primary">Regain <mark
                    class="px-2 text-primary bg-terti rounded-lg">control</mark> over your days</h1>
            <p class="text-lg font-normal text-secondary lg:text-xl">Here at Flowbite we focus on
        ...
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2 py-4 px-8 my-4 mx-auto max-w-screen-xl">
            <figure class="max-w-screen-md">
                ...
                <blockquote>
                    <p class="text-l font-semibold text-primary">"Flowbite is just awesome. It contains tons of
                ...
                <figcaption class="flex items-center mt-6 space-x-3 rtl:space-x-reverse">
                    ...
                    <div class="flex items-center divide-x-2 rtl:divide-x-reverse divide-secondary ">
                        <cite class="pe-3 font-medium text-primary">Bonnie Green</cite>
                        <cite class="ps-3 text-sm text-secondary">CTO at Flowbite</cite>
                    </div>
                </figcaption>
            </figure>
            <figure class="max-w-screen-md">
