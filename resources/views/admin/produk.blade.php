<x-admin>
    ...
    <section class="p-3 sm:p-5 antialiased">
        <div class="mx-auto max-w-full-2xl px-4 lg:px-2">
            <!-- Start coding here -->
            <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden w-full">
                <div
                    ...
                    <div
                        ...
                        <button type="button" id="createProductModalButton" data-modal-target="createProductModal"
                            ...
                            class="flex items-center justify-center text-primary bg-primary-700 border border-primary hover:bg-primary hover:text-white focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none">
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown"
                                class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-primary focus:outline-none bg-white rounded-lg border border-primary hover:bg-primary hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200"
                                type="button">
                            ...
                            <div id="actionsDropdown"
                                ...
                                <div class="py-1">
                                    <a href="#"
                                        class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Delete all</a>
                                </div>
                            </div>
                                ...
                                <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                    ...
                                    <li class="flex items-center">
                                        <input id="fitbit" type="checkbox" value=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">Fitbit
                                            (56)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="dell" type="checkbox" value=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="dell" class="ml-2 text-sm font-medium text-gray-900">Dell
                                            (56)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="asus" type="checkbox" value="" checked=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="asus" class="ml-2 text-sm font-medium text-gray-900">Asus
                                            (97)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="logitech" type="checkbox" value="" checked=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="logitech" class="ml-2 text-sm font-medium text-gray-900">Logitech
                                            (97)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="msi" type="checkbox" value="" checked=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="msi" class="ml-2 text-sm font-medium text-gray-900">MSI
                                            (97)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="bosch" type="checkbox" value="" checked=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="bosch" class="ml-2 text-sm font-medium text-gray-900">Bosch
                                            (176)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="sony" type="checkbox" value=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="sony" class="ml-2 text-sm font-medium text-gray-900">Sony
                                            (234)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="samsung" type="checkbox" value="" checked=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="samsung" class="ml-2 text-sm font-medium text-gray-900">Samsung
                                            (76)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="canon" type="checkbox" value=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="canon" class="ml-2 text-sm font-medium text-gray-900">Canon
                                            (49)</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="microsoft" type="checkbox" value=""
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 focus:ring-2">
                                        <label for="microsoft"
                                            class="ml-2 text-sm font-medium text-gray-900">Microsoft (45)</label>
                                    </li>
                                    <li class="flex items-center">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Xbox
                                    Series S</th>
                            ...
                            <tr class="border-b">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">NIKON
                                    D850</th>
        ...
        <div class="relative p-4 w-full max-w-xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                ...
                <dl>
                    ...
                    <dd class="mb-4 font-light text-gray-500 sm:mb-5">Standard glass ,3.8GHz 8-core 10th-generation
                        Intel Core i7 processor, Turbo Boost up to 5.0GHz, 16GB 2666MHz DDR4 memory, Radeon Pro 5500 XT
                        with 8GB of GDDR6 memory, 256GB SSD storage, Gigabit Ethernet, Magic Mouse 2, Magic Keyboard -
                        US.</dd>
    ...
    <div class="text-primary p-6">
        <div class="w-full max-w-6xl mx-auto">
            <div class="bg-white rounded-lg shadow p-4 mb-2 flex justify-between items-center cursor-pointer" onclick="toggleDropdown('productDetails1')">
            <div class="flex items-center gap-4">
                <img src="https://via.placeholder.com/60" class="w-16 h-16 object-cover rounded" alt="iMac">
                <div>
                <h2 class="text-lg font-bold mb-1">Apple iMac 27"</h2>
                <p class="text-sm text-gray-400">PC | Apple</p>
                </div>
            </div>
            <div class="text-right">
                <p class="text-xl font-bold text-terti mb-2">$2999</p>
                <span class="bg-green-600 text-white font-medium px-2 py-1 rounded text-xs">Active</span>
            </div>
            </div>

            <div id="productDetails1" class="hidden bg-white rounded-lg shadow p-4 mb-4">
            <p class="mb-2 text-sm text-primary">
                Standard glass, 3.8GHz 8-core 10th-generation Intel Core i7 processor, Turbo Boost up to 5.0GHz,<br>
                16GB 2666MHz DDR4 memory, Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD storage,<br>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                ...
                <div><strong>Shipping:</strong> Worldwide</div>
            ...
            <div class="mt-4 flex gap-3">
                <button class="hover:bg-[#E2F0DA] hover:text-primary text-white bg-green-600 font-medium px-4 py-2 rounded">Edit</button>
                <button class="hover:bg-[#DCECF5] hover:text-primary text-white bg-blue-500 font-medium px-4 py-2 rounded">Preview</button>
                <button class="hover:bg-[#FFD9D9] hover:text-primary text-white bg-red-700 font-medium px-4 py-2 rounded">Delete</button>
            </div>
            </div>
        </div>
...
{{-- 
    <div class="bg-gray-900 text-white p-">
        <div class="w-full max-w-4xl mx-auto space-y-4">
          <div class="product-item">
            <div class="bg-gray-800 rounded-lg shadow p-4 flex justify-between items-center cursor-pointer" onclick="toggleDropdown('productDetails1')">
              <div class="flex items-center gap-4">
                <img src="https://via.placeholder.com/60" class="w-16 h-16 object-cover rounded" alt="iMac">
                <div>
                  <h2 class="text-lg font-semibold">Apple iMac 27"</h2>
                  <p class="text-sm text-gray-400">PC | Apple</p>
                </div>
              </div>
              <div class="text-right">
                <p class="text-xl font-bold text-green-400">$2999</p>
                <span class="bg-green-600 px-2 py-1 rounded text-xs">Active</span>
              </div>
            </div>

            <div id="productDetails1" class="transition-all duration-500 ease-in-out overflow-hidden max-h-0 opacity-0 bg-gray-800 rounded-lg shadow p-4 mt-2">
              <p class="mb-2 text-sm text-gray-300">
                Standard glass, 3.8GHz 8-core 10th-gen Intel Core i7 processor, Turbo Boost up to 5.0GHz,<br>
                16GB 2666MHz DDR4 memory, Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD,<br>
                Gigabit Ethernet, Magic Mouse 2, Magic Keyboard - US.
              </p>

              <div class="grid grid-cols-3 gap-4 mb-4">
                <img src="https://via.placeholder.com/120x80" class="rounded object-cover" alt="Gallery 1">
                <img src="https://via.placeholder.com/120x80" class="rounded object-cover" alt="Gallery 2">
                <img src="https://via.placeholder.com/120x80" class="rounded object-cover" alt="Gallery 3">
              </div>
      
              <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                <div><strong>Product State:</strong> <span class="bg-blue-500 px-2 py-1 rounded text-xs">New</span></div>
                <div><strong>Shipping:</strong> Worldwide</div>
              ...
              <div class="mt-4 flex gap-3">
                <button class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded">Edit</button>
                <button class="bg-gray-500 hover:bg-gray-600 px-4 py-2 rounded">Preview</button>
                <button class="bg-red-600 hover:bg-red-700 px-4 py-2 rounded">Delete</button>
              </div>
            </div>
          </div>
        </div>
