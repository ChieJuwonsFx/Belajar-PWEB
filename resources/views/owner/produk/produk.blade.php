<x-owner>
    <div class="p-4 sm:p-6 w-full">
        <div class="flex flex-col lg:flex-row items-center justify-between w-full gap-4 mb-4">
            <form method="GET" action="{{ route('owner.produk') }}" class="w-full">
                <div class="flex flex-col sm:flex-row gap-2 sm:gap-4">
                    <div class="relative w-full sm:w-48 md:w-56">
                        <label for="category" class="sr-only">Kategori</label>
                        <select id="category" name="category"
                            class="appearance-none w-full py-2.5 px-4 text-sm font-medium text-gray-900 bg-white border border-primary rounded-lg hover:bg-white focus:ring-1 focus:border-primary focus:ring-gray-100">
                    ...
                    <div class="relative w-full">
                        ...
                        <button type="submit"
                            class="absolute top-1/2 right-2 -translate-y-1/2 p-2 text-white bg-primary rounded-lg border border-primary hover:text-primary hover:bg-white focus:ring-1 focus:outline-none focus:border-primary focus:ring-gray-100">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 2xl:grid-cols-3 gap-4">
    ...
    <div class="fixed bottom-6 right-6">
        <button onclick="openModal('add-produk')"
            class="p-4 bg-primary text-white border border-primary hover:bg-white hover:text-primary rounded-full shadow-lg transition-colors">
