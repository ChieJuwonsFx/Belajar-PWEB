<x-owner>
    <div class="p-6 w-full">   
        <div class="flex flex-col sm:flex-row items-center justify-between w-full">
            <form method="GET" action="{{ route('owner.produk') }}" class="flex-grow mb-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2 sm:gap-4 ml-4 items-center mb-4 sm:mt-0">
                <button onclick="openModal('kelola-kategori')" 
                ...
                <button onclick="openModal('kelola-unit')" 
                    class="px-4 py-2 bg-primary text-white border border-primary hover:text-primary hover:bg-white rounded-lg whitespace-nowrap">
                    Kelola Unit
                </button>
            </div>
    ...
    @include('owner.produk.kelolaCategory')
    @include('owner.produk.kelolaUnit')
