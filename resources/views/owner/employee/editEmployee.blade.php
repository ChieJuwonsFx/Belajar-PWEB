<div id="edit-employee-{{ $user->id }}" class="hidden fixed inset-0 z-50 overflow-y-auto">
    <div class="fixed inset-0 bg-black/50 backdrop-blur-sm transition-opacity" 
         onclick="closeModal('edit-employee-{{ $user->id }}')"></div>
        ...
        <div class="bg-primary p-6 text-white">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-primary-100">Ubah Data yang ingin diubah!</p>
                </div>
                <button type="button"                  
                    class="text-white hover:text-primary-100 transition-colors" onclick="closeModal('edit-employee-{{ $user->id }}')">
