<x-owner>
    <div class="px-6 pt-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 mb-6">
            <form method="GET" action="{{ route('owner.transaksi') }}" id="filter-form">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="relative w-full">
                        <select name="status" class="block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-lg font-medium text-gray-900">Tidak ada transaksi yang ditemukan</h3>
